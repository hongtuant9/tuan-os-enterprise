...
export const TCE_AGENT_REGISTRY: TceAgentDefinition[] = [
  ...
  },
  {
    ...
    outputs: [{ label: "CMO Content Queue / kế hoạch nội dung", href: "https://docs.google.com/spreadsheets/d/1N9Y1FVIm-Q1u2PZ3Mx6DdGj16F55c43SgAOoedfBUUw/edit", kind: "plan" }, { label: "AI Manager / CMO task", href: "/ai-manager", kind: "runtime" }, { label: "TASK-001 / SOC-001", href: "https://docs.google.com/spreadsheets/d/1uVG0L9FzcPBgOCk5IyWNuYVneCCgupqg-SH0TcERSjM/edit", kind: "task" }],
