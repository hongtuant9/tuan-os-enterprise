-- Restore TCE checklist sync source after fail-closed rollback.
-- Google Drive remains canonical; sync_records is an operational mirror only.
insert into public.sync_sources (
  key, name, description, sheet_id, sheet_range,
  supports_incremental, schedule_enabled, schedule_interval_minutes, status
)
values (
  'tce-checklist-daily',
