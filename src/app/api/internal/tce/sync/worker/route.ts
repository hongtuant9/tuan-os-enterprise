...
const MANAGED_SOURCES = new Set(["task-001", "approval-001", "l3-channel-tracking", "l3-ota-change-review"]);
...
export async function POST(req: NextRequest) {
  ...
  if (process.env.TCE_SYNC_WORKER_ENABLED?.trim().toLowerCase() === "false") {
