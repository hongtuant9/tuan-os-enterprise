  ...
  async dashboard(): Promise<ReceptionistDashboard> {
    ...
    const conversations: ReceptionistConversation[] = conversationRows.map((row) => {
      ...
      return {
        ...
        acquisitionSource: typeof metadata.acquisition_source === "string" ? metadata.acquisition_source : row.channel,
        ...
        referralSource: typeof metadata.referral_source === "string" ? metadata.referral_source : null,
