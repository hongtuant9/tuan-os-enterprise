    ...
    <div className="flex min-h-screen bg-[var(--page)]">
      ...
      <main className="flex-1 px-4 py-6 md:px-10 md:py-8">
        <header className="mb-6">
          ...
          <p className="mt-2 max-w-3xl text-sm leading-6 text-[var(--ink-secondary)]">Theo quyền hiện tại, hàng chờ này ưu tiên các quyết định liên quan tiền, chi phí, ngân sách, hoàn tiền và tài chính. Các việc kỹ thuật an toàn được hệ thống tự xử lý.</p>
        </header>
