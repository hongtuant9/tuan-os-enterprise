      ...
      return NextResponse.json(
        {
          ...
          features: { masterChangeControl: "v1", masterDataSteward: "v1", googleSheetsWriteScope: "v1", amenityStatusSync: "v1", marketingGrowthLoop: "v1", receptionistConversationV2: "v2", receptionistAllowlistChannelGate: "v1" },
          agentRegistry: 16,
